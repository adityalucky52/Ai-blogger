    ...
    <div className={`flex flex-col h-full bg-sidebar ${className}`}>
      ...
      <div className="p-6">
        <Link to="/" className="flex items-center gap-2">
          <div className="h-9 w-9 rounded-lg bg-gradient-to-br from-rose-600 to-orange-600 flex items-center justify-center">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 border-b bg-background/80 backdrop-blur-md flex items-center justify-between px-4 lg:px-6">
          ...
          <div className="lg:hidden flex items-center gap-2">
            <div className="h-8 w-8 rounded-lg bg-gradient-to-br from-rose-600 to-orange-600 flex items-center justify-center">
              ...
              <DropdownMenuContent className="w-56" align="end">
                <div className="flex items-center gap-2 p-2">
                  <Avatar className="h-8 w-8">
                    <AvatarImage src={mockAdmin.avatar} alt={mockAdmin.name} />
                    <AvatarFallback className="bg-gradient-to-br from-rose-600 to-orange-600 text-white text-sm">
                      {mockAdmin.name?.charAt(0).toUpperCase()}
                    </AvatarFallback>
                  </Avatar>
                  <div className="flex flex-col">
